{
  ...
  "source": {
    "http": "https://github.com/RNCommon/HyphenateDevice/raw/zip/iOS_Pods_IMDeviceSDK_V3.5.1.zip"
  },
  "platforms": {
    "ios": "8.0"
  },
  "requires_arc": true,
  "preserve_paths": "iOS_Pods_IMDeviceSDK_V3.5.1/Hyphenate.framework",
  "vendored_frameworks": "iOS_Pods_IMDeviceSDK_V3.5.1/Hyphenate.framework",
  "xcconfig": {
    "OTHER_LDFLAGS": "-ObjC"
  }
}
